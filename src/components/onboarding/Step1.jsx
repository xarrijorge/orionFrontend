...
const Step1 = () => {
    ...
    return (
        <Stack sx={{ maxWidth: 878 }} variant='outlined' className='card'>
            ...
            <CardContent>
                <form className='signupform' onSubmit={(e) => { next() }}>
                    <div className='inputs'>

                        <div className='formgroup'>
                            <label htmlFor="name"> <span className='Red'>*</span>Name of property</label>
                        ...
                        <div className='formgroup'>
                            ...
                            <input type="text" value={nou} placeholder='10' onChange={(e) => setNou(e.target.value)} />
                        </div>
                        ...
                        <div className='formgroup'>
                            <label htmlFor="address"> <span className='Red'>*</span>Address</label>
                        ...
                        <div className="flex-row">
                            ...
                            <div className='formgroup'>
                                ...
                                <input type="text" value={statee} placeholder='Enter State' onChange={(e) => setStatee(e.target.value)} />
                            </div>
                        </div>
                    </div>

                    <Button type='submit' className='signup_button' variant="contained">Next</Button>
            ...
            <CardContent>
                <Link className='green' to="/loading">skip </Link>
            </CardContent>
        </Stack>
    )
}
